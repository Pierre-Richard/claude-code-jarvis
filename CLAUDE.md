...
Ce workspace est le Jarvis personnel de Pierre-Richard. Il a été créé avec le Jarvis Starter Kit pour servir d'assistant IA personnel au quotidien.
...
Je m'appelle Pierre-Richard et je vis à Paris. Je suis développeur fullstack Angular / C# .NET avec 5 ans d'expérience, actuellement salarié et en recherche active d'un nouveau poste.

Mes objectifs prioritaires actuels sont de finir mon side project (application de gestion scolaire), décrocher une certification AWS Cloud / IA, monter en compétence sur Angular et .NET, et démarrer une activité freelance.

À long terme, je veux être installé en freelance avec un TJM confortable et des clients récurrents, et avoir lancé mon propre produit SaaS générant un revenu complémentaire.

Le domaine où j'ai besoin du plus d'aide en ce moment : accompagnement technique sur mon side project, apprentissage et formation (Angular, .NET, prépa AWS), et productivité au quotidien.
